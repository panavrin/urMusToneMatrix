...
dac = dac or _G["FBDac"]
fbPush = FlowBox("object", "mypush", FBPush)
fbSinOsc = FlowBox("object","upSinOsc", _G["FBSinOsc"])
fbZpulse = FlowBox("object","upZpulse", FBZPuls)
fbPush:SetPushLink(0,fbSinOsc, 0)  
fbZpulse:SetPullLink(0,fbSinOsc,0);
dac:SetPullLink(0,fbZpulse,0)
--fbPull = FlowBox("object", "mypull", FBPull)
--fbPull:SetPullLink(0,fbZpulse, 0)

local log = math.log

freq = 12.0/96.0*log(0.5/55)/log(2)
